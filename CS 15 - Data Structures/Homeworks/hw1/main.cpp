...
* Main application
* Purpose:  Running and testing the LargeNumber class
*********************************************/
#include <iostream>
...
//Does: Calls parameterized constructor with non-zero arguement for size and 0 arguement for digit
...
//Does: Calls parameterized constructor with digit arguement out of range
void parameterizedContstructorError()
{
	cout << "*** parameterizedContstructorError ***" << endl;
	//LargeNumber myNum = LargeNumber(3, 10);

	cout << "Exception thrown:  \"Value is not a digit:  10\"  Test passed!" << endl
		 << endl;
}

//Does: Calls parameterized constructor with non-zero arguement for size and 0 arguement for digit and checks if equal to 0
void isZeroTrue()
{
...
//Does: Calls parameterized constructor with non-zero arguement for size and non-zero arguement for digit and checks if not equal to 0
void isZeroFalse()
{
...
//Does: Calls makeZero function and checks if LargeNumber is equal to 0
void clearTest()
{
	cout << "*** clearTest ***" << endl;
	LargeNumber myNum = LargeNumber(3, 1);
...
void basicInsertLowestHighest()
{
	...
	cout << "Should print out: [LargeNumber of size 5: 15555]" << endl;
	myNum.insertHighestDigit(1);
	cout << "My output: ";
	myNum.print();
	cout << endl;

	cout << "Should print out: [LargeNumber of size 6: 155551]" << endl;
...
void basicInsertAtReplace()
{
	...
	cout << "Should print out: [LargeNumber of size 5: 55155]" << endl;
	myNum.insertAt(1, 2);
	cout << "My output: ";
	myNum.print();
	...
	cout << "Should print out: [LargeNumber of size 5: 53155]" << endl;
	myNum.replace(3, 1);
	cout << "My outout: ";
	myNum.print();
...
//Does: Calls insertAt and replace with out of range indeces and values
...
//Does: Inserts multiple new digits in order to force expand calls
void insertCallingExpand()
{
	cout << "*** insertCallingExpand ***" << endl;
	LargeNumber myNum = LargeNumber(1, 1);

	cout << "Should print out: [LargeNumber of size 11: 10123456789]" << endl;

	for (int i = 0; i < 10; i++)
	{
		myNum.insertLowestDigit(i);
	}
...
//Does: Tries to insert a 0 as the most significant digit of LargeNumber
void insertLeadingZeros()
{
	cout << "*** insertLeadingZeros ***" << endl;
	LargeNumber myNum = LargeNumber(4, 5);

	cout << "Should print out: [LargeNumber of size 4: 5555]" << endl;
...
void insertsWithZero()
{
	...
	cout << "Should print out: [LargeNumber of size 4: 5505]" << endl;
...
void basicRemoveAt()
{
	...
	cout << "Should print out: [LargeNumber of size 3: 59]" << endl;
	myNum.insertHighestDigit(1);
...
//Does: Removes multiple digits in order to forse a shrink call
void removeCallingShrink()
{
	cout << "*** removeCallingShrink ***" << endl;
	LargeNumber myNum = LargeNumber(40, 5);
	cout << "Removing enough to call shrink" << endl;
	cout << "Should print out: [LargeNumber of size 4: 5555]" << endl;
...
//Does: Inserts a 0 as the most significant digit then removes it right away
void removeLeadingZeros()
{
	cout << "*** removeLeadingZeros ***" << endl;
	LargeNumber myNum = LargeNumber(5, 5);

	cout << "Shourld print out: [LargeNumber of size 4: 5555]" << endl;
...
void basicConcatenate()
{
	...
	cout << "Should print out: [LargeNumber of size 6: 555222]" << endl;
...
void basicAdding()
{
	...
	cout << "Should print out: [LargeNumber of size 4: 1998]" << endl;
	myNum3.add(myNum3);
