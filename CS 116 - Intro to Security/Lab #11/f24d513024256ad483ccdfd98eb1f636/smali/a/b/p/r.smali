...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, La/b/p/r;->a:Landroid/widget/ProgressBar;
...
.method public b()Landroid/graphics/Bitmap;
    ...
    .line 145
    iget-object v0, p0, La/b/p/r;->b:Landroid/graphics/Bitmap;
...
.method public c(Landroid/util/AttributeSet;I)V
    ...
    .line 52
    iget-object v0, p0, La/b/p/r;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, La/b/p/r;->c:[I
    ...
    invoke-virtual {v0, v2}, La/b/p/w0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 57
    iget-object v3, p0, La/b/p/r;->a:Landroid/widget/ProgressBar;

    invoke-virtual {p0, v1}, La/b/p/r;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v3}, La/b/p/w0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, v2}, La/b/p/r;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 76
    invoke-virtual {p0, v0, p2}, La/b/p/r;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    check-cast v1, La/f/f/l/b;

    invoke-interface {v1, v0}, La/f/f/l/b;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v6, v7}, La/b/p/r;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, La/b/p/r;->b:Landroid/graphics/Bitmap;

    if-nez v3, :cond_7

    .line 101
    iput-object v2, p0, La/b/p/r;->b:Landroid/graphics/Bitmap;

    .line 104
    :cond_7
    new-instance v3, Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {p0}, La/b/p/r;->a()Landroid/graphics/drawable/shapes/Shape;
...
.method public final e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v5, v6}, La/b/p/r;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
