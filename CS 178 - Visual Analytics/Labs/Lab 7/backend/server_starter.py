...
from project_somerville import project_somerville
...
def confusionMatrix():
    ...
    pca_results_json_obj, mds_results_json_obj, tsne_results_json_obj, umap_results_json_obj = project_somerville()

    projection_result = [pca_results_json_obj, mds_results_json_obj, tsne_results_json_obj, umap_results_json_obj]
