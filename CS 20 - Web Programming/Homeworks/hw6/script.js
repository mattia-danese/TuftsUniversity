...
function updateDOM(num1, num2, num1_factors, num2_factors, num1_factors_sum, num2_factors_sum){
    ...
    // displays factors of each number
    document.getElementById("factors1").innerHTML = "The factors of " + num1 + " are: " + num1_factors.join();
    document.getElementById("factors2").innerHTML = "The factors of " + num2 + " are: " + num2_factors.join();
}
