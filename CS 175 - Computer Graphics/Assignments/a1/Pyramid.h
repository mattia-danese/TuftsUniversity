        ...
        for (int i = 0; i < sides[0].size() - (segment_x+1) - 1; i++) {
            ...
            if (skip_counter != 0 && skip_counter % (segment_x+1) != 0) {
                ...
                if (v) {
                    ...
                    // bottom-right triangle of square
                    setNormal(sides[0][i + segment_x + 2][0], sides[0][i + segment_x + 2][1], sides[0][i + segment_x + 2][2],
                        sides[0][i][0], sides[0][i][1], sides[0][i][2],
                        sides[0][i + 1][0], sides[0][i + 1][1], sides[0][i + 1][2]);
                    ...
                    setNormal(sides[0][i][0], sides[0][i][1], sides[0][i][2],
                        sides[0][i+segment_x+2][0], sides[0][i+segment_x+2][1], sides[0][i+segment_x+2][2],
                        sides[0][i+segment_x+1][0], sides[0][i+segment_x+1][1], sides[0][i+segment_x+1][2]);
        ...
        for (int i = 0; i < sides[2].size() - (segment_x+1) - 1; i++) {
            ...
            if (skip_counter != 0 && skip_counter % (segment_x+1) != 0) {
                ...
                if (v) {
                    ...
                    // bottom-right triangle of square
                    setNormal(sides[2][i + segment_x + 2][0], sides[2][i + segment_x + 2][1], sides[2][i + segment_x + 2][2],
                        sides[2][i + 1][0], sides[2][i + 1][1], sides[2][i + 1][2],
                        sides[2][i][0], sides[2][i][1], sides[2][i][2]);
                    ...
                    // top-left triangle of square
                    setNormal(sides[2][i + segment_x + 1][0], sides[2][i + segment_x + 1][1], sides[2][i + segment_x + 1][2],
        ...
        for (int i = 0; i < sides[3].size() - (segment_x+1) - 1; i++) {
            ...
            if (skip_counter != 0 && skip_counter % (segment_x+1) != 0) {
                ...
                if (v) {
                    ...
                    // not smooth
                    // bottom-right triangle of square
                    setNormal(sides[3][i][0], sides[3][i][1], sides[3][i][2],
                        sides[3][i+1][0], sides[3][i+1][1], sides[3][i+1][2],
                        sides[3][i + segment_x + 2][0], sides[3][i + segment_x + 2][1], sides[3][i + segment_x + 2][2]);
                    ...
                    setNormal(sides[3][i][0], sides[3][i][1], sides[3][i][2],
                        sides[3][i + segment_x + 2][0], sides[3][i + segment_x + 2][1], sides[3][i + segment_x + 2][2],
                        sides[3][i + segment_x + 1][0], sides[3][i + segment_x + 1][1], sides[3][i + segment_x + 1][2]);
        ...
        for (int i = 0; i < sides[4].size() - (segment_x+1) - 1; i++) {
            ...
            if (skip_counter != 0 && skip_counter % (segment_x+1) != 0) {
                ...
                if (v) {
                    ...
                    // not smooth
                    // bottom-right triangle of square
                    setNormal(sides[4][i + segment_x + 2][0], sides[4][i + segment_x + 2][1], sides[4][i + segment_x + 2][2],
                        sides[4][i + 1][0], sides[4][i + 1][1], sides[4][i + 1][2],
                        sides[4][i][0], sides[4][i][1], sides[4][i][2]);
                    ...
                    // top-left triangle of square
                    setNormal(sides[4][i + segment_x + 1][0], sides[4][i + segment_x + 1][1], sides[4][i + segment_x + 1][2],
